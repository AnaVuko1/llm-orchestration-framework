...
class OpenAIProvider(BaseProvider):
    ...
    def __init__(
        ...
        Args:
            ...
            base_url: Base URL for OpenAI API (for Azure or custom endpoints)
    ...
    def count_tokens(self, text: str) -> int:
        ...
        Note:
            This is an approximation. For accurate counts, use tiktoken.
            We use a simple approximation: ~4 chars per token for English text.
        """
        # Rough approximation: 1 token ≈ 4 characters for English text
        # For better accuracy, could integrate tiktoken
        if not text:
            return 0
        return len(text) // 4
    ...
    def supports_model(self, model: str) -> bool:
        ...
        Returns:
            True if model is supported (starts with gpt-)
        """
